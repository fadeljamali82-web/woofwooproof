...
const SectionHeader = ({ title, subtitle, centered = true }: { title: string, subtitle?: string, centered?: boolean }) => (
  <div className={`mb-12 md:mb-16 ${centered ? 'text-center' : 'text-left'}`}>
    <FadeIn>
      <h2 className="text-4xl md:text-5xl lg:text-6xl text-brand-navy mb-4 leading-tight tracking-tight">
        {title}
      </h2>
      {subtitle && (
        <p className="text-lg md:text-xl text-brand-text/50 max-w-xl mx-auto leading-relaxed">
          {subtitle}
        </p>
      )}
    </FadeIn>
...
export const Home = () => {
  ...
  return (
    ...
    >
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[85vh] flex items-center justify-center pt-24 pb-16 px-6 bg-gradient-soft overflow-hidden">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          <div className="text-center lg:text-left space-y-6">
            <FadeIn>
              ...
              <h1 className="text-5xl md:text-7xl lg:text-8xl leading-[0.95] text-brand-navy tracking-tighter">
                Better play. <br />
                <span className="text-brand-text/30">Built from plants.</span>
              </h1>
              <p className="text-lg md:text-xl text-brand-text/60 max-w-lg mx-auto lg:mx-0 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              <div key={i}>
                <FadeIn delay={i * 0.1}>
                  <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-brand-sky/20 h-full hover:shadow-md transition-shadow">
                    <div className="w-10 h-10 bg-brand-sky/20 rounded-xl flex items-center justify-center mb-5 text-brand-navy">
                      {React.cloneElement(item.icon as React.ReactElement, { size: 20 })}
                    </div>
                    <h3 className="text-xl text-brand-navy mb-3">{item.title}</h3>
      ...
      <section className="section-padding px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-end mb-12">
            {[
              ...
              <div key={i}>
                <FadeIn delay={i * 0.1}>
                  <div className="text-center group">
                    ...
                    <p className="text-[10px] font-bold uppercase tracking-widest text-brand-text/30">{item.weight}</p>
                  </div>
                </FadeIn>
              </div>
            ))}
      ...
      <section className="section-padding px-6 bg-brand-navy text-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <FadeIn>
              <h2 className="text-4xl md:text-6xl mb-4 tracking-tight">The ecosystem is growing.</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
            {[
              ...
              <div key={i}>
                <FadeIn delay={i * 0.1}>
                  <div className="bg-white/5 border border-white/10 p-6 rounded-[1.5rem] hover:bg-white/10 transition-colors">
      ...
      <section className="py-32 px-6 bg-gradient-soft text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10 space-y-8">
          <FadeIn>
            <h2 className="text-5xl md:text-8xl text-brand-navy leading-[0.95] tracking-tighter">
              Be part of the <br />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-2">
              <Link to="/back-us">
                <Button size="lg" className="px-14">Back on Kickstarter</Button>
              </Link>
              <div className="flex items-center gap-2 text-brand-navy/40 font-bold uppercase tracking-widest text-[9px]">
